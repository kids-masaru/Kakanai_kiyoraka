        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
            <div className="max-w-5xl mx-auto px-2 md:px-4 py-3 flex items-center justify-between gap-2">
                ...
                <div className="flex-1 flex items-center gap-2 overflow-x-auto no-scrollbar min-w-0 px-1">
                    ...
                    <Link href="/csv-convert" className={`${linkBaseClass} hidden md:flex ${isActive('/csv-convert') ? activeClass : inactiveClass}`}>
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                        <span>CSV変換</span>
                    </Link>
                    <Link href="/pdf-tool" className={`${linkBaseClass} hidden md:flex ${isActive('/pdf-tool') ? activeClass : inactiveClass}`}>
